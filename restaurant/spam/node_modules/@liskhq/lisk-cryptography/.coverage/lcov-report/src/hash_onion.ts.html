...
<head>
    <title>Code coverage report for src/hash_onion.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> hash_onion.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">1001000x</span>
<span class="cline-any cline-yes">1001000x</span>
...
export const hashOnion = (
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (count &lt; distance) {
<span class="cstat-no" title="statement not covered" >		throw new Error(</span>
			'Invalid count or distance. Count must be greater than distance',
		);
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (count % distance !== 0) {
<span class="cstat-no" title="statement not covered" >		throw new Error('Invalid count. Count must be multiple of distance');</span>
	}
&nbsp;
