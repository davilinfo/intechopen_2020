...
<head>
    <title>Code coverage report for src/encrypt.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> encrypt.ts</h1>
        <div class='clearfix'>
...
&nbsp;
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (publicKeyUint8Array === null) {
<span class="cstat-no" title="statement not covered" >		throw new Error('given public key is not a valid Ed25519 public key');</span>
	}
&nbsp;
