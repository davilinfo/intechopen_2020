...
<head>
    <title>Code coverage report for src/buffer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> buffer.ts</h1>
        <div class='clearfix'>
...
export const intToBuffer = (
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (![BIG_ENDIAN, LITTLE_ENDIAN].includes(endianness)) {
<span class="cstat-no" title="statement not covered" >		throw new Error(</span>
	...
	if (endianness === 'big') {
		if (byteLength &lt;= MAX_NUMBER_BYTE_LENGTH) {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (signed) {
<span class="cstat-no" title="statement not covered" >				buffer.writeIntBE(Number(value), 0, byteLength);</span>
			} else {
				buffer.writeUIntBE(Number(value), 0, byteLength);
			}
		} else {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (signed) {
<span class="cstat-no" title="statement not covered" >				buffer.writeBigInt64BE(BigInt(value));</span>
			} else {
		...
		if (byteLength &lt;= MAX_NUMBER_BYTE_LENGTH) {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (signed) {
<span class="cstat-no" title="statement not covered" >				buffer.writeIntLE(Number(value), 0, byteLength);</span>
			} else {
				buffer.writeUIntLE(Number(value), 0, byteLength);
			}
		} else {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (signed) {
<span class="cstat-no" title="statement not covered" >				buffer.writeBigInt64LE(BigInt(value));</span>
			} else {
...
&nbsp;
export const stringToBuffer = <span class="fstat-no" title="function not covered" >(s</span>tr: string): Buffer =&gt; <span class="cstat-no" title="statement not covered" >Buffer.from(str, 'utf8');</span>
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Nov 11 2020 12:08:55 GMT+0100 (Central European Standard Time)
            </div>
        </div>
